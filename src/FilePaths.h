#ifndef ICYTOWER_FILEPATHS_H
#define ICYTOWER_FILEPATHS_H
#include <string>
...
//const std::string fontPath("resources/VT323-Regular.ttf");
...
//const std::string scoreTablePath("resources/scoreTable.txt");
...
const std::string logoPath = "C:/Programowanie/IcyTower/proi_projekt/resources/icon.png";
...
const std::string scoreTablePath("C:/Programowanie/IcyTower/proi_projekt/resources/scoreTable.txt");


#endif //ICYTOWER_FILEPATHS_H
